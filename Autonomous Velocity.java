 ...
 */
@Autonomous(name = "AutonomousVelocity", group = "Drive")
public class AutonomousVelocity extends LinearOpMode {
    ...
    */
    ...
    private void showShooterRPM() {
        double leftRPM = shooterLeft.getVelocity() * 60.0 / SHOOTER_TICKS_PER_REV;
        double rightRPM = shooterRight.getVelocity() * 60.0 / SHOOTER_TICKS_PER_REV;
